...
//         let reversedStr = [];
//         str.split('').forEach(char => reversedStr.unshift(char));
//         return reversedStr.join('');
//     };

//     return { method1, method2, method3, method4, method5 }
// };
// console.log(reverseString().method5('hello'));
...
//     //// ES6 Method?
//     // squared.forEach((square, i) => {
//     //     if (square > squared[i + 1]) {
...
//         if (s.includes(value)) { sub.push(cases[value]) }
//     });
    
//     let values = s.split('').map(char => object[char]);
//     return [...sub, ...values].reduce((a, b) => a + b, 0);
// };
...
//     const copyArray = parseInt(array.slice().join(''));
//     const reversedArray = parseInt(array.reverse().join(''));    
//     return copyArray === reversedArray;
// };
// isPalindrome(x);
